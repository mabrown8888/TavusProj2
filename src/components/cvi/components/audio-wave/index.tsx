...
import { useActiveSpeakerId, useAudioLevelObserver } from "@daily-co/daily-react";
  ...
  return (
    <div className={styles.container}>
      <div className={styles.waveContainer}>
        <div ref={leftBarRef} className={`${styles.bar} ${!isActiveSpeaker ? styles.barInactive : ""}`} />
        <div ref={centerBarRef} className={`${styles.bar} ${!isActiveSpeaker ? styles.barInactive : ""}`} />
        <div ref={rightBarRef} className={`${styles.bar} ${!isActiveSpeaker ? styles.barInactive : ""}`} />
      </div>
    </div>
  );
});
